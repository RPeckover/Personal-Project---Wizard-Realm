...
const vid = document.getElementById("wizardVideo"); //Jake Hobbs - VARIABLE SELECTING VIDEO ELEMENT IN INDEX.HTML TO BE ABLE TO CHANGE SOURCE AND PLAY VIDEOS BASED ON USER PROGRESS
...
function submitForm(event){
    event.preventDefault();// prevents pressing the orb form's default behaviour of the enter key refreshing the web page
    };

// foundWords.forEach(function(foundList, index) {
//     console.log(foundList);
// }); WANT TO PRINT 'foundWords' array contents better than currently
