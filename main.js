...
// let trinkets = [
//     ["Ornament", "The golden ornament of the far plains. Some would say that this artefact holds untold value. I would say that you’re welcome to pay me untold amounts if you’d like!  Sales pitch aside - its lustre is finely rendered by artisans, a rare collaboration between the finest craftsmen of the underground and the surface. While it may not have been made for a practical purpose, it was formed with true reverence for the art of making."],
//     ["Draws", "Carved from the bow of a wish-granting tree struck by lightning one night, these draws may contain any number of small items but it shall only grant the user what they need. Sadly, the draws currently aren’t working as intended due to my ambient magics having been siphoned by the loss of the words! I did however discover this cypher upon its side... [INSERT CYPHER]"],
...
//     ["Barnabus", "Barnabus C. Horatio was a jealous mage who hoarded arcane knowledge and attempted to lay waste to several kingdoms for criticising his hat. As recompense he is now imprisoned in a cage of plush fabric. Though his days terrorising the lands are long gone, his pettiness still lingers. Barnabus has long since become naught but a nuisance in lieu of dominating the world."],
...
//     ["Effigy", "Ah the effigy. Enigmatic as ever, it seldom communicates though it's very apparent it is more conscious than it would appear! Sometimes when I am not looking it turns to face me, it’s rather unnerving! See if you can’t get it to utter some words. Perhaps the loss of the secret words shall compel it to interact."]
// ];